					...
					<div class="container_oc">
						...
						<div class="row">
							<div id="content_oc" class="col-sm-12">
								...
								<form action="cart_order.jsp" method="post" id="myform">
									<div class="table-responsive cart-info">
										<table class="table table-bordered">
											<tbody>
											<tr>
												<td class="text-right" width="20%">货物是否完好：</td>
											...
											<tr>
												<td class="text-right">是否按预计时间到达：</td>
												<td class="text-left quantity">
													<div class="input-group btn-block" style="max-width: 400px;">
								...
								<div><br></div>
								<a href="index.jsp"><button type="button" class="btn btn-primary btn-primary">提交</button></a>
								<a href="myorder.jsp"><button type="button" class="btn btn-primary btn-primary">返回</button></a>
								<!-- //填写物流信息的表单 -->
							</div>
						</div>
					</div>
