                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form class="form-inline">
                                    <label for="email" style="font-weight: inherit">起始日期：</label>
                                    <input type="week" class="form-control" id="email" placeholder="Enter email">
                                    <label for="pwd" style="margin-left: 50px;font-weight: inherit">结束日期：</label>
                                    <input type="week" class="form-control" id="pwd" placeholder="Enter password">
                                    <button type="submit" class="btn btn-primary" style="margin-left: 60px">查看</button>
                                </form>
                            </div>
                        </div>
                    </div>
