					...
					<div class="mr-megamenu animate slide" data-duration="400"
						...
						<ul class="nav navbar-nav level0">
							...
							<li itemprop="name" data-id="510" data-level="1"><a
								...
								href="goodsList0.jsp" data-target="#">转炉钢</a></li>
							<li itemprop="name" data-id="510" data-level="1"><a
								id="wenyi" itemprop="url" class="" href="goodsList1.jsp"
								data-target="#">平炉钢</a></li>
							<li itemprop="name" data-id="510" data-level="1"><a
								id="jiaoyu" itemprop="url" class="" href="goodsList2.jsp"
								data-target="#">电炉钢</a></li>
						</ul>
					</div>
