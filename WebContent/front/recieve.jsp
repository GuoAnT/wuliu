                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-weight: bold">已领取订单</h3>
                            </div>
                            <div class="panel-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>湛江</td>
                                        <td>2010.07.10</td>
                                        <td><button style="background: #555555;color:rgb(220,220,220);border:none;border-radius: 2px")">详细</button></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
