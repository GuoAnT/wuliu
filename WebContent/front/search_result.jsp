									...
									<div class="box-content1">
										...
										<div class="row">
											...
											<div
												...
												<div class="product-thumb">
													<div class="actions">
														<div class="image">
															<a href="goodsDetail.jsp?ID=1 "><img
														...
														<div class="button-group btn-grid">
															<div class="cart">
																<button class="btn btn-primary btn-primary"
																	...
																	onclick='javascript:window.location.href="cart_add.jsp?goodsID=1&num=1"; '
													...
													<div>
														<div class="caption">
															<div class="name">
																<a href="goodsDetail.jsp?ID=1" style="width: 95%">
																	<span style="color: #0885B1">商品名：</span>亚拓斯钢</a>
															</div>
															<p class="price">
																<span class="price-new">分类：</span> <span>冷镀钢</span>
																<span class="price-tax">价格: 999元
																</span>
															</p>
														</div>
										...
										<div class="row pagination">
											<table width="100%" border="0" cellspacing="0"
												cellpadding="0">
												<tr>
													<td height="30" align="right">当前页数：[2/3]&nbsp;
                                                        <%--判断翻页按钮的显示方式
														<%
															if (Page > 1) {
														%>
														--%>
                                                        <a href="search_result.jsp?Page=1&searchword=唐国安sb">第一页</a>
														<a href="search_result.jsp?Page=1&searchword=唐国安sb">上一页</a>
                                                        <%--
														<%
															}
															if (Page < maxPage) {
														%>
														 --%>
                                                        <a href="search_result.jsp?Page=3&searchword=唐国安sb>">下一页</a>
														<a href="search_result.jsp?Page=3&searchword=唐国安sb">最后一页&nbsp;</a>
                                                        <%--
														<%
															}
														%>
