							...
							<div id="content_oc" class="col-sm-12">
								<div class="box_oc">
									<div class="box-heading">
										<h1 class="mrshop_heading_h1">平炉钢</h1>
									</div>
									<div class="box-content">
										...
										<div class="row">
											...
											<div
												...
												<div class="product-thumb">
													<div class="actions">
														<div class="image">
															<a style="width: 95%" href="goodsDetail.jsp"><img
													...
													<div>
														<div class="caption">
															<div class="name">
																<a href="goodsDetail.jsp" style="width: 95%">
																	<span style="color: #0885B1">名称：</span>艾瑞利亚钢</a>
															</div>

															<p class="price">
																<span class="price-new">分类：</span> <span>平炉钢</span>
										...
										<div class="row pagination">
											<table width="100%" border="0" cellspacing="0"
												cellpadding="0">
												<tr>
													<td height="30" align="right">当前页数：[1/1]&nbsp;
														 <a href="goodsList0.jsp">第一页</a> <a
														href="goodsList0.jsp">上一页</a>
														<a href="goodsList0.jsp">下一页</a>
														<a href="goodsList0.jsp">最后一页&nbsp;</a>
													</td>
												</tr>
											</table>
										</div>
