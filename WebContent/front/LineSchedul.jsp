...
<div id="wrapper">
                    ...
                    <div class="col-md-6" style="width: 1350px;">
                        <div class="panel" >
                            <div class="panel-heading">
                                <h3 class="panel-title">线路调度</h3>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        起点：
                                        <select style="background:#fafdfe;
    height:28px;
    width:180px;
    line-height:28px;
    border:1px solid #9DB1B6;
    ...
    border-radius:2px;">
                                        ...
                                        <button style="margin-left: 70px;border-radius:3px;border: none;font-size:16px;background:#9DB1B6;color:#f2f2f2;">查询</button>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin-top: 10px">
                                    <div class="col-md-6">
                                        <button style="margin-left: 70px;border-radius:3px;border: none;font-size:16px;background:#9DB1B6;color:#f2f2f2;">增加承运商</button>
                                    </div>
                                    <div class="col-md-6">
                                        <button style="margin-left: 70px;border-radius:3px;border: none;font-size:16px;background:#9DB1B6;color:#f2f2f2;">移除承运商</button>
                                    </div>
                                </div>
                            </div>
                        </div>
