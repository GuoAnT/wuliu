                            ...
                            <div class="panel-body">
                                <from>
                                    <div class="form-group">
                                        <label for="danhao">请输入查询单号</label>
                                        <input type="number" class="form-control" placeholder="请输入单号" id="danhao">
                                    </div>
                                    <div class="form-group">
                                        <label for="sel1">请选择问题类型:</label>
                                    ...
                                    <div class="form-group">
                                        <a href="liaotian.jsp" target="_blank">
                                        <button type="submit" class="btn btn-primary" style="width: 100%;margin-top: 10px">咨询</button>
                                        </a>
                                    </div>
                                </from>
                            </div>
...
<script type="text/javascript">
    ...
    //创建地图函数：
    function createMap(){
        var map = new BMap.Map("myditu");//在百度地图容器中创建一个地图
        var point = new BMap.Point(118.513581,31.676265);//定义一个中心点坐标
